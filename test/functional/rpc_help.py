...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        components = ['Blockchain', 'Control', 'Mining', 'Network', 'Omni layer (configuration)', 'Omni layer (data retrieval)', 'Omni layer (payload creation)', 'Omni layer (raw transactions)', 'Omni layer (transaction creation)', 'Rawtransactions', 'Util']
