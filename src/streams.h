...
public:
    ...
    explicit CDataStream(const char *begin, const char *end, int type, int version)
        : CDataStream(Span<const uint8_t>{(const uint8_t*)begin, (const uint8_t*)end}, type, version) {}
